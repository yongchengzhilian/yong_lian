...
public class AesUtils {
    /*
        ...
        */
    private String sKey = "aiDou9999!@#$%_";//key，可自行修改
    private String ivParameter = "%……&*…Ag…￥";//偏移量,可自行修改
    ...
    public static void main(String[] args) throws Exception {
       ...
       // String enString = Base64.encodeBase64String(AesUtils.getInstance().encrypt(cSrc).getBytes());
