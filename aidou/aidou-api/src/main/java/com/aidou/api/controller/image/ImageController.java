package com.aidou.api.controller.image;
...
public class ImageController extends BaseController {
    ...
    @ApiOperation(value = "图片Token", notes = "图片Token")
    @RequestMapping(value = "/token",method = RequestMethod.GET)
    public AidouResult getFile(){
        String qiNiuToken = imageUtil.findQiNiuToken();
        return  AidouResult.success(qiNiuToken);
    }
